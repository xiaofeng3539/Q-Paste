...
const zh: Record<string, string> = {
  ...
  'toast.updated': '内容已更新',
  'toast.batchCopied': '已复制 {n} 条内容',
  'toast.batchPinned': '已收藏 {n} 条记录',
  'toast.batchUnpinned': '已取消收藏 {n} 条记录',
  'toast.batchTagged': '已为 {n} 条记录添加标签「{tag}」',
  'toast.batchDeleted': '已删除 {n} 条记录',
  'toast.batchConfirmDelete': '选中的 {n} 条记录中包含收藏内容，删除后无法恢复，确定删除吗？',
...
const en: Record<string, string> = {
  ...
  'sidebar.batchCopy': 'Copy',
  'sidebar.batchPin': 'Pin',
  ...
  'toast.batchCopied': 'Copied {n} items',
  'toast.batchPinned': 'Pinned {n} items',
  'toast.batchUnpinned': 'Unpinned {n} items',
  'toast.batchTagged': 'Tagged {n} items with "{tag}"',
  'toast.batchDeleted': 'Deleted {n} items',
  'toast.batchConfirmDelete': '{n} selected items include pinned content. Deletion is not recoverable. Delete?',
